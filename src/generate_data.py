...
def build_prompt(
    ...
    return (
        ...
        "- Dátum mezőknél SOHA ne használd a mai valós naptári dátumot "
        "alapértelmezésként (pl. sajtóközlemény keltezéseként) — mindig "
        "találj ki egy, a kitalált történethez illő, változatos dátumot, "
        "vagy hagyd ki/null-ozd, ha a szövegben nincs konkrét dátum "
        "megemlítve.\n"
